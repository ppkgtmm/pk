      ...
      <ul className="flex flex-col space-y-10 md:space-y-12">
        ...
        <li>
          ...
          <p className="mt-2 mb-4">
            ...
            hyperparameters tuned after an algorithm was finalized depending on
            performance on preprocessed news data
          </p>
        ...
        <li>
          ...
          <p className="mt-2 mb-4">
            ...
            lyrics and words related to the emotion. Also, users can list songs
            or emotions, see song lyrics, add new emotion categories with
            related words and remove songs from particular emotion categories
          </p>
